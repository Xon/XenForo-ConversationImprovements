...
{
    public function getConversationMessages($conversationId, array $fetchOptions = [])
    {
    ...
    public function getConversationMessagesByIds(array $messageIds, array $fetchOptions = [])
    {
        if (empty($messageIds))
        {
            return [];
    ...
    public function canViewConversation(array $conversation, &$errorPhraseKey = '', array $viewingUser = null)
    {
        ...
        {
            $conversation['all_recipients'] = $this->getConversationRecipientsForSearch(
